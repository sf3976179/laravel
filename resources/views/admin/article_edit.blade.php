...
@section('content')
                    ...
                    <form name="form_data" id="myupload" method="POST" data-parsley-validate class="form-horizontal form-label-left" action="{{ route('file_upload') }}" enctype="multipart/form-data">
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="first_title" id="first-name" required="required" class="form-control col-md-7 col-xs-12" value="{{ $article_info->main_title }}" />
                        </div>
                      </div>
                      <div class="shangchuan" style="width:15%;height:100px;margin-top:-3.55rem;float:right;display:inline;">
                        <div class="pic" style="display:inline;">
                          <img id="src" src="{{url('printing')}}/<?php echo $article_info->image_name;?>" style="width:150px;height:100px;">
                      ...
                      <div class="form-group" >
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" id="last-name" name="second_titile" required="required" class="form-control col-md-7 col-xs-12" value="{{ $article_info->subtitle }}">
                        </div>
                      </div>
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div class="btn-group">
                            <button type="button" class="btn btn-danger" id="article_list1">{{ $article_info->ac_name1 }}</button>
                          ...
                          <div class="btn-group">
                            <button type="button" class="btn btn-danger" id="article_list2">{{ $article_info->ac_name2 }}</button>
                            <button type="button" class="btn btn-danger dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                              <span class="caret"></span>
                              <span class="sr-only">Toggle Dropdown</span>
                            </button>
                      ...
                      <div class="control-group">
                        ...
                        <div class="col-md-9 col-sm-9 col-xs-12">
                          <input name="tags_1" id="tags_1" type="text" class="tags form-control" value="{{ $article_info->ac_tag }}" />
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <div id="gender" class="btn-group" data-toggle="buttons">
                            <label class="btn <?php if($article_info->ac_display == '0'){echo 'btn-default active';}else{echo 'btn-default';}?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="display" value="0" <?php if($article_info->ac_display == '0'){echo 'checked';}?>> &nbsp; 公开 &nbsp;
                            </label>
                            <label class="btn <?php if($article_info->ac_display == '1'){echo 'btn-primary active';}else{echo 'btn-primary';}?>" data-toggle-class="btn-primary" data-toggle-passive-class="btn-default">
                              <input type="radio" name="display" value="1" <?php if($article_info->ac_display == '1'){echo 'checked';}?>> 私人
                            </label>
                          </div>
                        </div>
                      </div>
        ...
        <script type="text/javascript">
            ...
            $(".edui-body-container").css("height", "350px");
